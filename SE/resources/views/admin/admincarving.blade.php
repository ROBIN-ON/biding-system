...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm">
            <div class="card-body">
                <a href="{{ route('create.carving') }}" href="" class="btn btn-primary bg-purple">ADD</a>
        ...
        <form action="" class="col-9">
            ...
            <button class="btn btn-danger">search</button>
            <a href="admin/admincarving">
                <button class="btn btn-primary">Reset-Page</button>
            </a>
        </form>

        @foreach ($postcarving as $admincarving)
        ...
        <div class="card" style="width: 60rem; height:140vh; padding: 1rem; margin: 3rem;">
            <div class="card-body">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$admincarving->auction_title}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1" >
                    ...
                    <div class="col-8">
                        <p>{{$admincarving->auction_period}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$admincarving->lot_reference_number}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$admincarving->estimate_price}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$admincarving->lot_description}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm">
                <div class="card-body">
                    ...
                    <a href="{{route('carving.delete',['carvingid'=>$admincarving->carving_id])}}" class="btn btn-primary bg-purple">Delete</a>
                    <a href="{{route('carving.edit',['carvingid'=>$admincarving->carving_id])}}" class="btn btn-primary bg-purple">edit</a>
