...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm">
            <div class="card-body">
                <a href="{{ route('create.photograph') }}" href="" class="btn btn-primary bg-purple">ADD</a>
        ...
        <form action="" class="col-9">
            ...
            <button class="btn btn-danger">search</button>
            <a href="admin/adminphotograph">
                <button class="btn btn-primary">Reset-Page</button>
            </a>
        </form>

        @foreach ($postphotograph as $adminphotograph)
        ...
        <div class="card" style="width: 60rem; height:140vh; padding: 1rem; margin: 3rem;">
            <div class="card-body">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->auction_title}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->auction_date}}</p>
                    </div>
                </div>
                <div class="row p-1" >
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->auction_period}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->lot_reference_number}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->lot_number}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->piece_title}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->estimate_price}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminphotograph->lot_description}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm">
                <div class="card-body">
                    ...
                    <a href="{{route('photograph.delete',['photographid'=>$adminphotograph->photograph_id])}}" class="btn btn-primary bg-purple">Delete</a>
                    <a href="{{route('photograph.edit',['photographid'=>$adminphotograph->photograph_id])}}" class="btn btn-primary bg-purple">edit</a>
