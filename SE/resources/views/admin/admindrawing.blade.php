...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm">
            <div class="card-body">
                <a href="{{ route('create.drawing') }}" href="" class="btn btn-primary bg-purple">ADD</a>
        ...
        @foreach ($postdrawing as $admindrawing)
        ...
        <div class="card" style="width: 60rem; height:140vh; padding: 1rem; margin: 3rem;">
            <div class="card-body">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$admindrawing->auction_title}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1" >
                    ...
                    <div class="col-8">
                        <p>{{$admindrawing->auction_period}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$admindrawing->lot_reference_number}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$admindrawing->estimate_price}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$admindrawing->lot_description}}</p>
                    </div>
                </div>
                {{-- <div>
                ...
                <div class="col-sm">
                    @if (!empty($admindrawing->image))
                    <img style="width:87%;"src="{{ asset('storage/images/' . $admindrawing->image) }}" alt="{{ $admindrawing->image }}">
                @else
            ...
            <div class="col-sm">
                <div class="card-body">
                    ...
                    <a href="{{route('drawing.delete',['drawingid'=>$admindrawing->drawing_id])}}" class="btn btn-primary bg-purple">Delete</a>
                    <a href="{{route('drawing.edit',['drawingid'=>$admindrawing->drawing_id])}}" class="btn btn-primary bg-purple">edit</a>
