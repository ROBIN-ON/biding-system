...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm">
            <div class="card-body">
                <a href="{{ route('create.sculptures') }}" href="" class="btn btn-primary bg-purple">ADD</a>
        ...
        <form action="" class="col-9">
            ...
            <button class="btn btn-danger">search</button>
            <a href="admin/adminsculptures">
                <button class="btn btn-primary">Reset-Page</button>
            </a>
        </form>

        @foreach ($postsculptures as $adminsculptures)
        ...
        <div class="card" style="width: 60rem; height:140vh; padding: 1rem; margin: 3rem;">
            <div class="card-body">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->auction_title}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->auction_date}}</p>
                    </div>
                </div>
                <div class="row p-1" >
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->auction_period}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->lot_reference_number}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->lot_number}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->piece_title}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->estimate_price}}</p>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col-4" style="background-color: gray;">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-8">
                        <p>{{$adminsculptures->lot_description}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm">
                <div class="card-body">
                    ...
                    <a href="{{route('sculptures.delete',['sculpturesid'=>$adminsculptures->sculptures_id])}}" class="btn btn-primary bg-purple">Delete</a>
                    <a href="{{route('sculptures.edit',['sculpturesid'=>$adminsculptures->sculptures_id])}}" class="btn btn-primary bg-purple">edit</a>
