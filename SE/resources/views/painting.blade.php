...
<body>
    ...
    <div class="container">
        ...
        @foreach ($viewpaintingpublic as $painting)
            <div class="card" style="width: 60rem; height:140vh; padding: 1rem; margin: 3rem;">
                <div class="card-body">
                    ...
                    <div class="row p-1">
                        ...
                        <div class="col-8">
                            <p>{{ $painting->lot_reference_number }}</p>
                        </div>
                    </div>
                    <div class="row p-1">
                        <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-sm">
                        @if (!empty($painting->image))
                            <img style="width:87%;"src="{{ asset('storage/images/' . $painting->image) }}"
                                alt="{{ $painting->image }}">
                        @else
