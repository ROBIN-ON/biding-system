...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('admin/image/logo.jpg') }}" alt="Logo" height="40">
        </a>
    ...
    <div class="container">
        ...
        @foreach ($viewcarvingpublic as $carving)
            <div class="card" style="width: 60rem; height:140vh; padding: 1rem; margin: 3rem;">
                <div class="card-body">
                    ...
                    <div class="row p-1">
                        ...
                        <div class="col-8">
                            <p>{{ $carving->lot_reference_number }}</p>
                        </div>
                    </div>
                    <div class="row p-1">
                        <div class="col-4" style="background-color: gray;">
                    ...
                    <div class="col-sm">
                        @if (!empty($carving->image))
                            <img style="width:87%;"src="{{ asset('storage/images/' . $carving->image) }}"
                                alt="{{ $carving->image }}">
                        @else
